  ...
  return (
    <div className="home flex justify-center position-relative">
      ...
      <img
        ...
        src={HomeBackground}
        style={{ objectFit: true, width: "100%" }}
      />
      <div className="container flex flex-col mt-52">
              ...
              >
                <div
                  className={`${
                    activeTab === TabType.Tour
                      ? "text-primary-100"
                      : "text-white hover:text-primary-100 hover:bg-white"
                  } py-2 px-4`}
        ...
        <div className="sale-section mb-16 z-20">
          <h2 className="mb-5 text-4xl text-white">Ưu đãi</h2>
          <Sale />
        </div>
